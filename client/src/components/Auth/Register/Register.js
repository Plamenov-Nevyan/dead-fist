          ...
          <fieldset className={styles['register-fieldset']} id={styles['btn-fieldset']}>
            ...
            <div className={styles['tac-container']}>
              <span className={styles['tac-span']}>
                 I agree with the 
                 <span className={styles['tac-modal']}>Terms and Conditions</span>
              </span>
              <input onChange={(e) => onValsChange(e)} type='checkbox' name="tac" id="tac" className={styles['tac-input']} />
            </div>
          </fieldset>
          <span className={styles['redirect-span']}>
            Have an account already? 
            <NavLink to="/login" className={styles['redirect-link']}>Sign In</NavLink>
          </span>
            </form>
          </div>
        </section>
