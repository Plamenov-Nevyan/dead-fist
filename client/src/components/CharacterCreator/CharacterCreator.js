...
export function CharacterCreator() {
  ...
  const { setCharData, charData } = useCharacterData();
    ...
    <>
      ...
      {showConfirmModal && (
        <Modal
          ...
          text={
            "Are you sure you want to create this character ? You wont be able to edit stats later."
          }
          showCloseBtn={true}
      ...
      <section className={styles["char-creator-section"]}>
        <h2 className={styles["creator-heading"]}>
          It's time to create your survivor!
        </h2>
        <div className={styles["slider-container"]}>
          <h3 className={styles["choose-avatar-heading"]}>
            Choose your avatar
          </h3>
          <AvatarsSlider
            avatars={
