...
export function SkillsSelector({
  ...
  return (
    <>
      <h2 className={styles["assign-heading"]}>
        Assign skills and character information
      </h2>
      <div className={styles["character-gender"]}>
        <h3 className={styles["gender-heading"]}>
          {" "}
          Choose your character's gender
        </h3>
        <div className={styles["gender-options"]}>
          <div className={styles["option"]}>
            <label className={styles["gender-label"]} htmlFor="male">
              Male
            </label>
            <input
              onChange={(e) => onCharacterStatsChange(e)}
              type="radio"
              name="gender"
              value="male"
              checked={characterStats.gender === "male"}
            />
          </div>
          <div className={styles["option"]}>
            <label className={styles["gender-label"]} htmlFor="female">
              Female
            </label>
            <input
              onChange={(e) => onCharacterStatsChange(e)}
              ...
              name="gender"
              value="female"
              checked={characterStats.gender === "female"}
            />
          </div>
        </div>
      </div>
      <div className={styles["character-class"]}>
        <label className={styles["class-label"]} htmlFor="class">
          Choose your character's occupation before the end times
        </label>
        <select
          onChange={(e) => onCharacterStatsChange(e)}
          id="class"
      ...
      <div className={styles.skills}>
        <div className={styles["skills-description"]}>
          <h3 className={styles["descr-heading"]}>
            Choose your character's skills
          </h3>
          <h4 className={styles["remaining-heading"]}>
            Remaining points: {remainingSkillPoints}
          </h4>
        </div>
        {pointsError && (
          <h4 className={styles["points-error"]}>
            Please assign all of your skill points!
          </h4>
        )}
        <SkillContainer
          skillName={"Strength"}
      ...
      <div className={styles["character-bio"]}>
        <label className={styles["bio-label"]} htmlFor="bio">
          Write a short bio of your character (optional)
        </label>
        <textarea
          onChange={(e) => onCharacterStatsChange(e)}
          id="bio"
