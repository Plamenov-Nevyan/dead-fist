  ...
  return (
    <div className={styles["skill-container"]}>
      ...
      <div className={styles["value-manipulator"]}>
        <svg
          onClick={(e) => onIncreaseSkill(e)}
          className={styles["value-btn"] + " " + skillName.toLowerCase()}
      ...
      <h3 className={styles["skill-value"]}>
        {skillValues[skillName.toLowerCase()]}
      </h3>
      <div className={styles["value-manipulator"]}>
        <svg
          onClick={(e) => onDecreaseSkill(e)}
          className={styles["value-btn"] + " " + skillName.toLowerCase()}
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"
        >
